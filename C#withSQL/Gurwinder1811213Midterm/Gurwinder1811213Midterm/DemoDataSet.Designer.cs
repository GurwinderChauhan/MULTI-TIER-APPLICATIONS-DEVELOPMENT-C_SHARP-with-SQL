...
namespace Gurwinder1811213Midterm {
    ...
    public partial class DemoDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public StudentsRow AddStudentsRow(string FirstName, string LastName, string PhoneNumber) {
...
namespace Gurwinder1811213Midterm.DemoDataSetTableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Students] ([FirstName], [LastName], [PhoneNumber]) VALUES (@Fi" +
                "rstName, @LastName, @PhoneNumber);\r\nSELECT StudentNumber, FirstName, LastName, P" +
                "honeNumber FROM Students WHERE (StudentNumber = SCOPE_IDENTITY())";
...
SELECT StudentNumber, FirstName, LastName, PhoneNumber FROM Students WHERE (StudentNumber = @StudentNumber)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Gurwinder1811213Midterm.Properties.Settings.Default.DemoConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT StudentNumber, FirstName, LastName, PhoneNumber FROM dbo.Students";
        ...
        public virtual int Delete(int Original_StudentNumber, string Original_FirstName, string Original_LastName, string Original_PhoneNumber) {
        ...
        public virtual int Update(string FirstName, string LastName, string PhoneNumber, int Original_StudentNumber, string Original_FirstName, string Original_LastName, string Original_PhoneNumber, int StudentNumber) {
            if ((FirstName == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[10].Value = ((int)(StudentNumber));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string PhoneNumber, int Original_StudentNumber, string Original_FirstName, string Original_LastName, string Original_PhoneNumber) {
            return this.Update(FirstName, LastName, PhoneNumber, Original_StudentNumber, Original_FirstName, Original_LastName, Original_PhoneNumber, Original_StudentNumber);
        }
    }
